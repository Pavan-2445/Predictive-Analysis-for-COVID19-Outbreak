...
def load_data():
    ...
    latest_data = pd.read_csv('01-15-2023.csv')
...
st.markdown("Note: This model is still building don't take it as reference until it is completely build. It mat took some time. Thank you!")
